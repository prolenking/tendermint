...
func init() {
	...
	cdc.RegisterConcrete(PubKeyMultisigThreshold{}, PubKeyMultisigThresholdAminoRoute, nil)
	...
	cdc.RegisterConcrete(sr25519.PubKeySr25519{}, sr25519.PubKeyAminoName, nil)
